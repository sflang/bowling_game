class Game
  ...
  def play(ball_scores)
    ...
    init_frame_scores(ball_score_array)
  ...
  #and initialize the frame objects with this array
  def init_frame_scores(ball_scores)
	...
	#push the first and second ball_scores into the ball_scores array when required
